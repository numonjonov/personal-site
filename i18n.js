  ...
  en: {
    ...
    help: {
      ...
      rows: [
        ...
        ['bg',         'backgrounds: tunnel, stars, matrix, meteor, horizon, web'],
  ...
  ru: {
    ...
    help: {
      ...
      rows: [
        ...
        ['bg',         'фоны: tunnel, stars, matrix, meteor, horizon, web'],
  ...
  uz: {
    ...
    help: {
      ...
      rows: [
        ...
        ['about',      'oʻzim haqimda batafsil'],
        ['experience', 'ish tajribasi va taʼlim'],
        ...
        ['bg',         'fonlar: tunnel, stars, matrix, meteor, horizon, web'],
